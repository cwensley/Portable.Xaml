...
// See the https://github.com/dotnet/corefx/blob/master/LICENSE.TXT file in the project root for more information.
    ...
    public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        private void InitializeFromCollection(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        {
            ...
            foreach (KeyValuePair<TKey, TValue> pair in collection)
            {
                ...
                {
                    throw new ArgumentException("Source contains duplicate keys");
                }
            }
        ...
        internal ConcurrentDictionary(int concurrencyLevel, int capacity, bool growLockArray, IEqualityComparer<TKey> comparer)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(concurrencyLevel), "ConcurrentDictionary_ConcurrencyLevelMustBePositive");
            }
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), "ConcurrentDictionary_CapacityMustNotBeNegative");
            }
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int index)
        {
            ...
            if (index < 0) throw new ArgumentOutOfRangeException(nameof(index), "ConcurrentDictionary_IndexIsNegative");
		...
		static readonly KeyValuePair<TKey, TValue>[] EmptyArray = new KeyValuePair<TKey, TValue>[0];
        ...
        {
	        throw new KeyNotFoundException("Key not found with key " + key);
        }
